...
<<1+1+2+4=8>>
<<-.5+1=0.5>>
Never write <<6*7>>, <<6*7>>=42 or <<6*7=>>.
Inside << >>, use only numbers, decimal points, parentheses, +, -, *, / and =.
Do not use words, variables, units, currency symbols, percentages or LaTeX.
